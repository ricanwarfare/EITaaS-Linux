...
bad_paths=$(git ls-files | grep -E '(^|/)(\.agents|\.agent|\.codex|\.claude|\.cursor|\.windsurf|\.gemini|\.env|\.secrets)(/|$|\.)|\.(rdp|rdpw|har|pcap|pcapng|key|pem|p12|pfx|cer|crt|der|p7b|p7c|env)$' || true)
